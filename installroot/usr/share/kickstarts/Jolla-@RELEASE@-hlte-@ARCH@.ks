# DisplayName: Jolla hlte/@ARCH@ (release) 1
...
repo --name=adaptation0-hlte-@RELEASE@ --baseurl=https://store-repository.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-samsung-hlte/@ARCH@/
...
%packages
@Jolla Configuration hlte
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/hlte
